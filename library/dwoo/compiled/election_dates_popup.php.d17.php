...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
	<tr>
		<td align="left" width="100%" style="font-size:12px;" colspan="2"><b><?php echo $this->scope["LANG_SELECT_STATE_TEXT"];?>:</b> <select name="selState" id="selState" class="from-input" onchange="this.form.submit();" style="float:none;">
								<option value=""><?php echo $this->scope["LANG_SELECT_A_STATE_TEXT"];?></option>
...
<table cellpadding="0" cellspacing="0" border="0" class="listtab" width="100%" style="clear:both;">
  <tr bgcolor="#a9cdf5" class="txtbo">
	<td width="20%" align="left" nowrap="nowrap"><strong><?php echo $this->scope["LANG_ELECTION_TYPE_TEXT"];?></strong>
		<?php $objpaging->_sortImages("election_type_name", $cmn->getCurrentPageName()); ?></td>
	<td width="20%" align="left" nowrap="nowrap"><strong><?php echo $this->scope["LANG_STATE_TEXT"];?></strong>
		<?php $objpaging->_sortImages("state_code", $cmn->getCurrentPageName()); ?></td>
	<td  width="25%" align="left"><strong><?php echo $this->scope["LANG_ELECTION_DATES_TEXT"];?></strong>
		<?php $objpaging->_sortImages("election_date", $cmn->getCurrentPageName()); ?></td>
	<td width="25%" align="left"><strong><?php echo $this->scope["LANG_REGISTRATION_DEADLINE_DATE_TEXT"];?></strong>
...
</table></form><?php  /* end template body */
