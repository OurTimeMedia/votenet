...
<link href="../design_templates/template1/css/skin.css" rel="stylesheet" type="text/css" />
<link href="../design_templates/template1/css/ei.css" rel="stylesheet" type="text/css" />
<link href="../design_templates/template1/css/thickbox.css" rel="stylesheet" type="text/css" />
<link href="../voter/css/message.css" rel="stylesheet" type="text/css" />

<script src="../design_templates/template1/js/jquery-1.4.2.min.js" type="text/javascript"></script>
<script src="../design_templates/template1/js/jquery.jcarousel.min.js" type="text/javascript"></script>
<script language="javascript" type="text/javascript" src="../design_templates/template1/js/jquery-ui-1.8.4.custom.min.js"></script>
<script language="javascript" type="text/javascript" src="../design_templates/template1/js/jquery.validate.js"></script>
<link href="../design_templates/template1/css/calendar.css" rel="stylesheet" type="text/css" />
<link href="../design_templates/template1/css/jquery.datepick.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" language="javascript" src="../design_templates/template1/js/jquery.datepick.js"></script>
<script type="text/javascript" language="javascript" src="../design_templates/template1/js/jquery.datepick.ext.js"></script>
<script type="text/javascript" language="javascript" src="../design_templates/template1/js/registration-form.js"></script>
<script type="text/javascript" language="javascript" src="../design_templates/template1/js/thickbox.js"></script>
<script type="text/javascript" language="javascript" src="../design_templates/template1/js/format_phone.js"></script>
...
<link rel="stylesheet" type="text/css" media="screen" href="../design_templates/template1/css/mobile_device.css">
<?php 
}
else {
?>
