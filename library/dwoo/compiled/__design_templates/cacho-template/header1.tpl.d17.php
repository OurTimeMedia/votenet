...
<script src="../design_templates/cacho-template/js/jquery.min.js" type="text/javascript"></script>
...
<script type="text/javascript" language="javascript" src="../design_templates/cacho-template/js/jquery-ui-timepicker-addon.min.js"></script>
