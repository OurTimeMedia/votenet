...
<div id="content">
    <div class="content">
      <div class="step1-main">
        <div class="step1">
          <h1><?php echo $this->scope["reg_step"];?> 1: <?php echo $this->scope["reg_registration"];?></h1>
          <div class="step-table">
            <?php echo Dwoo_Plugin_include($this, 'registration_step1.php', null, null, null, '_root', null);?>
