<?php 
	header('Content-Type: application/x-msexcel; name=statebystate.xls');
	header('Content-Disposition: inline;filename=statebystate.xls');
...
$statewisedata = $objpaging->setPageDetails($objTopClient,"reports_state_by_state_summary.php",-1,$condition);
