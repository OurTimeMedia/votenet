<?php
	...
	$aAccess = $cmn->getAccess("client_admin_list.php", "client_admin_list", 11);	
            ...
            <div class="blue_title">
              <div class="blue_title_lt">
                <div class="blue_title_rt">
                  <div class="fleft">Client Admins</div>
                  <div class="fright"> <?php print $cmn->getAdminMenuLink("client_admin_addedit.php","client_admin_addedit","Create","","add_new.png");?> </div>
                </div>
              </div>
            </div>
						...
						{ 
                          ...
                          <tr class="<?php echo $strrow_class?>">
                            ...
                            <td width="10%" align="center">
                             <?php ($cmn->readValueDetail($arr[$i]["user_isactive"])==1) ? print 'Yes' : print 'No' ?>                             </td>
