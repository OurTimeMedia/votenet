...
$objStateRaceGroup->setAllValues($state_id);
      ...
      <div class="cont_lt">
        <div class="cont_rt">
            ...
            <div class="blue_title">
              <div class="blue_title_lt">
                <div class="blue_title_rt">
                  <div class="fleft"><?php print "Delete State - Race Group Join"; ?></div>
                  <div class="fright">
                   <?php print $cmn->getAdminMenuLink("racegroup_state_detail.php","racegroup_state_detail","Back","?state_id=".$state_id,"back.png",false); ?>
				   </div>
                </div>
              </div>
            </div>
          ...
          <form id="frm" name="frm" method="post">
        	Are you sure you want to delete Race Group Details for  <strong><?php print $racegroupdata[0]['state_code']." - ".$racegroupdata[0]['state_name'];?></strong> State?<br/><br/>
          ...
          <input type="button" title="Cancel" id="btncancel" name="btncancel" value="Cancel" class="btn" onclick="javascript: window.location.href='racegroup_state_detail.php?state_id=<?php print $state_id;?>';" />
        	</form>
        	</div>
            </div>
          </div>
