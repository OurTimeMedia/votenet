...
{	
	...
	<tbody>
	  <tr>
		<td width="88%" align="left" valign="middle"><strong>Keyword</strong>&nbsp;<input type="text" value="<?php echo $txtsearchname?>" class="reprot-input" name="txtsearchname" id="txtsearchname"/>
		&nbsp;&nbsp;
		...
		<td width="12%" align="right" valign="middle"><a id="dialog_link" style="padding-left:10px;text-decoration:none;">
		<input type="button" class="btn" value="Apply Filter" name="btnclear" id="filter_btn"/></a><input type="button" class="btn" value="Export to Excel" name="btnexport" id="btnexport" style="margin-top:5px;" onclick="javascript:document.frm.action='voter_registration_export.php';document.frm.submit(); document.frm.action='';"/></td>
	  </tr>
	</tbody>
	</table></td>
	</tr>
	...
	<input type="hidden" name="report_id" id="report_id" value="2" />	 
		<tr>
		  <?PHP			  
				...
				if(($i+1)%2==0) { $endTag = '</tr><tr>'; } else { $endTag = ''; }
		  ?>
