...
//	alert(eval(name));
	if(eval(name))
	{
		var new1="document.getElementById('race_groupname_"+language_name+"').style.display='';";
		eval(new1);		
	}
	else
	{
		var new1="document.getElementById('race_groupname_"+language_name+"').style.display='none';";
		eval(new1);		
	}
...
{
	window.location.href="race_group_list.php";
}

function setaction(actiontype)
{	
	document.frm.action = "race_group_list.php";
...
function setfocus()
{
	document.frm.race_group_name.focus();
}
...
function validate()
{
	...
	arValidate[index++] = new Array("R", "document.frm.race_group_name_"+defaultLanguageID, "Race Group Name");
