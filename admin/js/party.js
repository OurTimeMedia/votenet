...
//	alert(eval(name));
	if(eval(name))
	{
		var new1="document.getElementById('partyname_"+language_name+"').style.display='';";
		eval(new1);		
	}
	else
	{
		var new1="document.getElementById('partyname_"+language_name+"').style.display='none';";
		eval(new1);		
	}
...
function validate()
{
	...
	arValidate[index++] = new Array("R", "document.frm.party_name_"+defaultLanguageID, "Party Name");
