            ...
            <div class="user_tab_mn">
              <div class="blue_title">
                <div class="blue_title_lt">
                    ...
                    <div class="fleft">Usage Statistics Report</div>
  ...
  <tr>
	<td colspan="2" align="left">		  
		<table width="100%" cellpadding="0" cellspacing="0" class="listtab-rt-bro">
			<tbody>
			  <tr>
				<td width="78%" align="left" valign="middle"><strong>Date From</strong>&nbsp;<input type="text" value="" class="reprot-input" name="txtdatefrom" id="txtdatefrom"/>
				...
				&nbsp;&nbsp;&nbsp;
				<strong>Date To</strong>&nbsp;<input type="text" value="" class="reprot-input" name="txtdateto" id="txtdateto"/>
				...
				<input type="submit"  class="btn" value="Search" name="btnsearch" id="btnsearch"/>
				  &nbsp;
				<input type="button" class="btn" value="Clear" name="btnclear" id="btnclear" onclick="javascript:document.location.href='date_wise_report.php';"/>
				</td>				
				<td width="22%" align="right" valign="middle"><input type="button" class="btn" value="Export to Excel" name="btnclear" id="btnexport" onclick="javascript:document.frm.action='date_wise_report.php';document.frm.submit();"/></td>
			  </tr>
			</tbody>
		  </table></td>
  </tr>  
