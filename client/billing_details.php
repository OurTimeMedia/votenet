<?php
	...
	include "billing_details_db.php";
	...
	if ($mode==EDIT && !($cmn->isRecordExists("user", "user_id", $user_id, $record_condition)))
		$msg->sendMsg("billing_details.php","",46);
            ...
            <div class="blue_title">
              <div class="blue_title_lt">
                <div class="blue_title_rt">
                  <div class="fleft">Billing Details</div>
                        ...
                        <div class="content-box-lt">
                            <div class="content-box-rt">
                                <div class="blue_title_cont">
									<?php include SERVER_CLIENT_ROOT."billing_details_form.php";?>
								</div>
                            </div>
                        </div>
                    </div>
