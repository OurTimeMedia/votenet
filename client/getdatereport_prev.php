...
if (isset($_GET['txtdatefrom']) && $_GET['txtdatefrom'] != '') {
  ...
  // change date formate from MM/DD/YYYY to YYYY-MM-DD
...
$datedata = $objTopClient->datewisePrevdetail($frmdate, $client_id);
$str = '';

for ($i = 0; $i < count($datedata); $i++) {
  // change date formate from YYYY-MM-DD to MM/DD/YYYY
