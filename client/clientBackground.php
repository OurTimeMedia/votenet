<?php	
	...
	//$sBackgroundPath = SERVER_HOST . "common/files/background/" . $objWebsite->background_image;
	//$sBackgroundPath = AMAZON_S3_LINK.BUCKET_NAME."/ElectionImpactProd/files/background/" . $objWebsite->background_image;
		$sBackgroundPath = SERVER_HOST . BACKGROUND_IMAGE . $objWebsite->background_image;
?>
...
<form name="frm" id="frm" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" enctype="multipart/form-data" onSubmit="return designValidations();">
  <table width="950" cellspacing="0" cellpadding="0" border="0">
    <tbody>
      <tr>
        <td valign="top" align="left"><img src="<?php echo $sBackgroundPath; ?>" border="0"></td>
      </tr>
    </tbody>
  </table>
</form>  
