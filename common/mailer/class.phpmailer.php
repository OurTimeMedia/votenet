...
class PHPMailer {
   ...
   * @var string
   */
  var $Host        = '192.168.52.2'; //'localhost';	//SMTP HOST
  ...
  /**
   * Sets SMTP authentication. Utilizes the user_username and Password variables.
   * @var bool
   */
  var $SMTPAuth     = true;

  /**
   * Sets SMTP user_username.
   * @var string
   */
  var $user_username     = 'test@aipl.com'; //'';	//SMTP USER_NAME

  /**
   * Sets SMTP password.
   * @var string
   */
  var $Password     = 'test1';	//'';	//SMTP PASSWORD
  ...
  function SmtpConnect() {
    ...
    while($index < count($hosts) && $connection == false) {
      ...
      if($this->smtp->Connect(((!empty($this->SMTPSecure))?$this->SMTPSecure.'://':'').$host, $port, $this->Timeout)) {
        ...
        $connection = true;
        if($this->SMTPAuth) {
          if(!$this->smtp->Authenticate($this->user_username, $this->Password)) {
