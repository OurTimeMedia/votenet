...
class POP3
{
   ...
   */
  function Authorise ($host, $port = false, $tval = false, $user_username, $password, $debug_level = 0)
  {
    $this->host = $host;
    ...
    if ($result)
    {
      $login_result = $this->Login($this->user_username, $this->password);
  ...
  function Connect ($host, $port = false, $tval = 30)
    ...
    */
     ...
     * @return boolean
     */
    function Login ($user_username = '', $password = '')
    {
    ...
    $pop_user_username = "USER $user_username" . $this->CRLF;
    $pop_password = "PASS $password" . $this->CRLF;

      //  Send the user_username
      $this->sendString($pop_user_username);
      $pop3_response = $this->getResponse();
