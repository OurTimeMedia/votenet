...
//echo $objCurrentObject->pagingType;echo $strOrderBy;exit;
	...
	function setPageDetailsSpecial($objCurrentObject,$page1,$intRowsPerPage1,$cond = "", $id="",$join="",$limit='',$field='')
	{ 
...
//echo $objCurrentObject->pagingType;echo $strOrderBy;exit;
			...
			{
				case 'registantrpt':
					$rsPg = $objCurrentObject->registrantdetail("", $cond, $strOrderBy,$field,$limit);	
					break;						
				default:
					$rsPg = $objCurrentObject->fetchRecordSet("", $cond, $strOrderBy);	
					break;
