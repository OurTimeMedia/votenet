<?php
	...
	define("E_VAL_REQUIRED_VALUE_LAN",LANG_VAD_VALUE_FOR." <strong>%s.</strong>");
	define("E_VAL_MINLEN_CHECK_FAILED_LAN",LANG_VAD_LENGTH_MORE." <strong>%d</strong> ".LANG_VAD_FOR." <strong>%s.</strong>");
	define("E_VAL_ALNUM_CHECK_FAILED_LAN",LANG_VAD_ALPHA_NUMERIC." <strong>%s.</strong>");
	define("E_VAL_ALNUM_S_CHECK_FAILED_LAN",LANG_VAD_ALPHA_NUMERIC." <strong>%s.</strong>");
	define("E_VAL_NUM_CHECK_FAILED_LAN",LANG_VAD_NUMERIC." <strong>%s.</strong>");
	define("E_VAL_PASSWORD_CHECK_FAILED_LAN",LANG_VAD_VALID_INPUT." <strong>%s.</strong>");
	define("E_VAL_USERNAME_CHECK_FAILED_LAN",LANG_VAD_VALID_INPUT." <strong>%s.</strong>");
	define("E_VAL_FLOAT_CHECK_FAILED_LAN",LANG_VAD_NUM_IN." <strong>%s.</strong>");
	define("E_VAL_ALPHA_CHECK_FAILED_LAN",LANG_JS_ALPHA_NUMBER." <strong>%s.</strong>");
	define("E_VAL_FILEEXT_CHECK_FAILED_LAN",LANG_VAD_VALID_INPUT." <strong>%s.</strong>");
	define("E_VAL_XLSFILE_CHECK_FAILED_LAN",LANG_VAD_VALID_INPUT." <strong>%s.</strong>");
	define("E_VAL_FILEBLANKV_CHECK_FAILED_LAN",LANG_VAD_BLANK_ROWS.".");
	define("E_VAL_ALPHA_S_CHECK_FAILED_LAN",LANG_VAD_ALPHABETIC_INPUT." <strong>%s.</strong>");
	define("E_VAL_IPADDRESS_S_CHECK_FAILED_LAN",LANG_VAD_VALID." <strong>%s.</strong>");
	define("E_VAL_EMAIL_CHECK_FAILED_LAN",LANG_VAD_EMAIL.".");
	define("E_VAL_LESSTHAN_CHECK_FAILED_LAN","Enter a value less than <strong>%f</strong> for <strong>%s.</strong>");
	define("E_VAL_GREATERTHAN_CHECK_FAILED_LAN","Enter a value greater than <strong>%f</strong> for <strong>%s.</strong>");
	define("E_VAL_DATEGREATERTHAN_CHECK_FAILED_LAN","Enter a date value greater than <strong>%s</strong> for <strong>%s.</strong>");
	define("E_VAL_DATESMALLERTHAN_CHECK_FAILED_LAN","Enter a date value smaller than <strong>%s</strong> for <strong>%s.</strong>");
	define("E_VAL_REGEXP_CHECK_FAILED_LAN",LANG_VAD_VALID_INPUT." <strong>%s.</strong>");
	define("E_VAL_DONTSEL_CHECK_FAILED_LAN","Wrong option selected for <strong>%s.</strong>");
	define("E_VAL_SHOULD_SEL_CHECK_FAILED_LAN","Please select minimum <strong>%d</strong> options for <strong>%s.</strong>");
	define("E_VAL_SELMIN_CHECK_FAILED_LAN","Please select minimum <strong>%d</strong> options for <strong>%s.</strong>");
	define("E_VAL_SELONE_CHECK_FAILED_LAN","Please select an option for <strong>%s.</strong>");
	define("E_VAL_SELONE_ARRAY_CHECK_FAILED_LAN","Please select at least one <strong>%s.</strong>");
	define("E_VAL_EQELMNT_CHECK_FAILED_LAN",LANG_VAD_VALUE_OF." <strong>%s</strong> ".LANG_VAD_SAME." <strong>%s.</strong>");
	define("E_VAL_NEELMNT_CHECK_FAILED_LAN","Value of <strong>%s</strong> should not be same as that of <strong>%s.</strong>");
	define("E_VAL_DATE_CHECK_FAILED_LAN","Please enter valid <strong>%s</strong>.");
	define("E_VAL_DUPLICATE_CHECK_FAILED_LAN",LANG_VAD_DUPLICATE." <strong>%s</strong> ".LANG_VAD_FOUND.".");
	define("E_VAL_BIRTH_DATE_CHECK_FAILED_LAN","Please enter birth date not of future.");
	define("E_VAL_FILE_EXTENSION_CHECK_FAILED_LAN","Please select only <strong>%s</strong> file for <strong>%s.</strong>");
	define("E_VAL_NOT_FILE_EXTENSION_CHECK_FAILED_LAN","Please do not select <strong>%s</strong> file for <strong>%s.</strong>");
	define("E_VAL_NOT_VALID_FILE_TYPE","Please select valid file type for <strong>%s.</strong>");
	define("E_VAL_FILE_SELECTION_CHECK_FAILED_LAN","Please select file to upload for <strong>%s.</strong>");
	define("E_VAL_COMPANR_GREATERTHAN_CHECK_FAILED_LAN","Value of <strong>%s</strong> must be less than <strong>%s.</strong>");
	define("E_VAL_DATE_CHECK_FAILED_DD_MM_YYYY_LAN",LANG_VAD_VALID." <strong>%s.</strong>");
	define("E_VAL_NEW_EXISTING_PASSWORD",LANG_NEW_OLD_SAME_PASSWORD.".");
...
class validationlang
{
	...
	function validate()
	{
		...
		if ($return == false)
		{
			...
			$strmain = $msgcmn->getFileContent(SERVER_ROOT."common/templates/validation_msg.html");
			
			$strmain = str_replace("#strtitle", LANG_CORRECT_ERRORS.".", $strmain);
			$strmain = str_replace("#strsubtitle", $this->message, $strmain);
			$_SESSION["err"] = $strmain;
			$_SESSION["strsubtitle"] = strip_tags($this->message);
			$_SESSION["is_error"]=1;
		}
		...
		switch($command)
		{
			...
			case 'maxlen':
						{
							...
							$bret = $this->validateMaxLen($input_value,$max_len,$field_title,
			...
			case 'minlen':
						{
							...
							$bret = $this->validateMinLen($input_value,$min_len,$field_title,
											$default_error_message);
							break;
						}
			...
			case 'alnum':
						{
							...
							if(false == $bret)
							{
								if (trim($default_error_message)=="")
									$this->arrmessages[] = sprintf(E_VAL_ALNUM_CHECK_FAILED_LAN,$field_title);
								else
			...
			case 'alnum_s':
						{
							...
							{
								if (trim($default_error_message)=="")
									$this->arrmessages[] = sprintf(E_VAL_ALNUM_S_CHECK_FAILED_LAN,$field_title);
								else
									$this->arrmessages[] = sprintf($default_error_message, $field_title);
							}
							break;
            ...
            case 'numeric':
						{
							...
							{
								if (trim($default_error_message)=="")
									$this->arrmessages[] = sprintf(E_VAL_NUM_CHECK_FAILED_LAN,$field_title);
								else
									$this->arrmessages[] = sprintf($default_error_message, $field_title);
							}
							break;							
			...
			case 'float':
						{
							...
							{
								if (trim($default_error_message)=="")
									$this->arrmessages[] = sprintf(E_VAL_FLOAT_CHECK_FAILED_LAN,$field_title);
								else
									$this->arrmessages[] = sprintf($default_error_message, $field_title);
							}
							break;							
			...
			case 'alpha':
						{							
							...
							{
								if (trim($default_error_message)=="")
									$this->arrmessages[] = sprintf(E_VAL_ALPHA_CHECK_FAILED_LAN,$field_title);
								else
									$this->arrmessages[] = sprintf($default_error_message, $field_title);
							}
							break;
			...
			case 'password':
						{
							...
							{
								$this->arrmessages[] = sprintf(E_VAL_PASSWORD_CHECK_FAILED_LAN,$field_title);
								return false;	
							}
			...
			case 'username':
						{
							...
							{
								if (trim($default_error_message)=="")
									$this->arrmessages[] = sprintf(E_VAL_USERNAME_CHECK_FAILED_LAN,$field_title);
								else
									$this->arrmessages[] = sprintf($default_error_message, $field_title);
							}
							break;
			...
			case 'fileext':
						{
							...
							{
								if (trim($default_error_message)=="")
									$this->arrmessages[] = sprintf(E_VAL_FILEEXT_CHECK_FAILED_LAN,$field_title);
								else
									$this->arrmessages[] = sprintf($default_error_message, $field_title);
							}
							break;
			...
			case 'xlsfile':
						{	
							...
							{
								if (trim($default_error_message)=="")
									$this->arrmessages[] = sprintf(E_VAL_XLSFILE_CHECK_FAILED_LAN,$field_title);
								else
									$this->arrmessages[] = sprintf($default_error_message, $field_title);
							}
							break;
			...
			case 'filesize':
						{	
							...
							{	
								$bret=false;
								if (trim($default_error_message)=="")
									$this->arrmessages[] = sprintf(E_VAL_FILESIZE_CHECK_FAILED_LAN,$field_title);
								else
									$this->arrmessages[] = sprintf($default_error_message, $field_title);
			...
			case 'filesizebeforepost':
						{	
								$bret=false;
								if (trim($default_error_message)=="")
									$this->arrmessages[] = sprintf(E_VAL_FILESIZE_POST_CHECK_FAILED_LAN,$field_title);
								else
									$this->arrmessages[] = sprintf($default_error_message, $field_title);
			...
			case 'filesizeVal':
						{	
							$bret=false;
							if (trim($default_error_message)=="")
								$this->arrmessages[] = sprintf(E_VAL_MAX_FILE_SIZE_FAILED_LAN,$field_title);
							else
								$this->arrmessages[] = sprintf($default_error_message, $field_title);
			...
			case 'fileblank':
						{
							$bret=false;
							if (trim($default_error_message)=="")
								$this->arrmessages[] = sprintf(E_VAL_FILEBLANK_CHECK_FAILED_LAN,$field_title);
							else
								$this->arrmessages[] = sprintf($default_error_message, $field_title);
			...
			case 'fileblankv':
						{
							$bret=false;
							if (trim($default_error_message)=="")
								$this->arrmessages[] = sprintf(E_VAL_FILEBLANKV_CHECK_FAILED_LAN,$field_title);
							else
								$this->arrmessages[] = sprintf($default_error_message, $field_title);
			...
			case 'fields':
						{	
							$bret=false;
							if (trim($default_error_message)=="")
								$this->arrmessages[] = sprintf(E_VAL_FILEFIELDS_CHECK_FAILED_LAN,$field_title);
							else
								$this->arrmessages[] = sprintf($default_error_message, $field_title);
							break;
						}
			case 'alpha_s':
						{
							...
							{
								if (trim($default_error_message)=="")
									$this->arrmessages[] = sprintf(E_VAL_ALPHA_S_CHECK_FAILED_LAN,$field_title);
								else
									$this->arrmessages[] = sprintf($default_error_message, $field_title);
							}
							break;
			...
			case 'ipaddress':
						{
							...
							{
								if (trim($default_error_message)=="")
									$this->arrmessages[] = sprintf(E_VAL_IPADDRESS_S_CHECK_FAILED_LAN,$field_title);
								else
									$this->arrmessages[] = sprintf($default_error_message, $field_title);
							}
							else
			...
			case 'email':
						{
							if(isset($input_value) && strlen($input_value)>0)
							{
								...
								{
								if (trim($default_error_message)=="")
									$this->arrmessages[] = E_VAL_EMAIL_CHECK_FAILED_LAN;
								else
									$this->arrmessages[] = sprintf($default_error_message, $field_title);
								}
							}
			...
			case "lessthan": 
						{
							$bret = $this->validateLessThan($command_value,
													$input_value,
													$field_title,
													$default_error_message);
							break;
			...
			case "greaterthan": 
						{
							$bret = $this->validateGreaterThan($command_value,
													$input_value,
													$field_title,
													$default_error_message);
							break;
			...
			case "comparedate": 
						{	
							$bret = $this->validateDateCompare($command_value,
													$input_value,
													$field_title,
													$default_error_message);
			...
			case "comparedatev": 
						{	
							$bret = $this->validateDateCompareV($command_value,
													$input_value,
													$field_title,
													$default_error_message);
			...
			case "comparedatesmall": 
						{	
							$bret = $this->validateDateCompareSmall($command_value,
													$input_value,
													$field_title,
													$default_error_message);
							break;
			...
			case "inarr": 
						{	
							$this->arrmessages[] = sprintf(E_VAL_REGEXP_CHECK_FAILED_LAN,$field_title);
							$bret = false;
							break;
						}
			case "comp_gt": 
						{
							$bret = $this->validateCompareGreaterThan($command_value,
													$input_value,
													$field_title,
													$default_error_message);
							break;
          ...
          case "dontselectradio":
						{
							$bret = $this->validateDontSelect($input_value,
															   $command_value,
															   $default_error_message,
																$field_title);
							 break;
          ...
          case "selectradio":
                      {
                            $bret = $this->validateSelect($input_value,
							       $command_value,
							       $default_error_message,
								    $field_title);
                            break;
		  ...
		  case "selmin":
						{
							...
							else
							{
								$bret= false;
								if (trim($default_error_message)=="")
									$this->arrmessages[] = sprintf(E_VAL_SELMIN_CHECK_FAILED_LAN,$min_count,$field_title);
								else
									$this->arrmessages[] = sprintf($default_error_message, $field_title);
							}
						...
						{	
							if(!is_array($input_value))
							{
									...
									strlen($input_value)<=0)
								{
									$bret= false;
									if (trim($default_error_message)=="")
										$this->arrmessages[] = sprintf(E_VAL_SELONE_CHECK_FAILED_LAN,$field_title);
									else
										$this->arrmessages[] = sprintf($default_error_message, $field_title);
								}
							}	
		 ...
		 case "chk_arr":
						{
								...
								count($_REQUEST[$input_value])<=0)
							{
								$bret= false;
								if (trim($default_error_message)=="")
									$this->arrmessages[] = sprintf(E_VAL_SELONE_ARRAY_CHECK_FAILED_LAN,$field_title);
								else
									$this->arrmessages[] = sprintf($default_error_message, $field_title);
							}
							break;
		 ...
		 case "selfile":
		 				{	
							if($_FILES[$input_value]["size"]<=0)
							{
								$bret= false;
								if (trim($default_error_message)=="")
									$this->arrmessages[] = sprintf(E_VAL_FILE_SELECTION_CHECK_FAILED_LAN,$field_title);
								else
									$this->arrmessages[] = sprintf($default_error_message, $field_title);
							}
							break;
							...
							if (trim($input_value)!="")
							{
								...
								else 
								{
									...
									if(strcmp($input_value,$command_field[0])==0)
										...
										$bret= false;
									if (trim($default_error_message)=="")
										$this->arrmessages[] = sprintf(E_VAL_EQELMNT_CHECK_FAILED_LAN,$field_title,$command_field[1]);
									else
		  ...
		  case "neelmnt":
						{
							...
							if (trim($input_value)!="")
							{
								...
								else
								{
									$bret= false;
									if (trim($default_error_message)=="")
										$this->arrmessages[] = sprintf(E_VAL_NEELMNT_CHECK_FAILED_LAN,$field_title,$command_field[1]);
									else
										$this->arrmessages[] = sprintf($default_error_message, $field_title,$command_field[1]);
								}
							}
			...
			case "date":
						{
							if(strlen($input_value)>0 && $input_value!="MM/DD/YYYY" ){
								...
								if((substr_count($strdate,"/"))<>2){
									$bret= false;
									if (trim($default_error_message)=="")
										$this->arrmessages[] = sprintf(E_VAL_DATE_CHECK_FAILED_LAN,$field_title,$command_value);
									else
					...
					case "birthdate":
							if(strlen($input_value)>0 && $input_value!="MM-DD-YYYY" && (!isset($this->error_hash[$field_title]))){
								...
								if ($ardiff == false){
								   ...
								   $bret= false;
									if (trim($default_error_message)=="")
									   	$this->arrmessages[] = sprintf(E_VAL_BIRTH_DATE_CHECK_FAILED_LAN,$field_title,$command_value);
									else
										$this->arrmessages[] = sprintf($default_error_message, $field_title);
								 }
							}
				...
				case "check_date":
					if (isset($input_value) && trim($input_value)!="")
					{
						...
						if (!checkdate($arrdt[0], $arrdt[1], $arrdt[2]))
						{
							$bret= false;
							if (trim($default_error_message)=="")
									$this->arrmessages[] = sprintf(E_VAL_DATE_CHECK_FAILED_DD_MM_YYYY_LAN,$field_title,$command_value);
							else
								$this->arrmessages[] = sprintf($default_error_message, $field_title);
						}
						else
				...
				case "dupli":
							if(isset($input_value) && strlen($input_value)>0){
								...
								if($rsdupli && mysql_num_rows($rsdupli)){
									$bret= false;
									if (trim($default_error_message)=="")
										$this->arrmessages[] = sprintf(E_VAL_DUPLICATE_CHECK_FAILED_LAN,$field_title);
									else
										$this->arrmessages[] = sprintf($default_error_message, $field_title);
								}			
				...
				case "dupliusername":
							if(isset($input_value) && strlen($input_value)>0){
								...
								if($rsdupli && mysql_num_rows($rsdupli)){
									$bret= false;
									if (trim($default_error_message)=="")
										$this->arrmessages[] = sprintf(E_VAL_DUPLICATE_USERNAME_LAN,$field_title);
									else
										$this->arrmessages[] = sprintf($default_error_message, $field_title);
								}			
								mysql_free_result($rsdupli);
							...
							if(isset($input_value) && strlen($input_value)>0){
								if (isset($_FILES[$input_value]["name"]) && $_FILES[$input_value]["size"]>0) {
									...
									if (!isset($file_info["extension"]) || !in_array($file_extension,$arr_ext))
									{
										$bret = false;
										if (trim($default_error_message)=="")
											$this->arrmessages[] = sprintf(E_VAL_FILE_EXTENSION_CHECK_FAILED_LAN, $command_value, $field_title);
										else
											$this->arrmessages[] = sprintf($default_error_message, $field_title);
									}
								}
							...
							if(isset($input_value) && strlen($input_value)>0){
								if (isset($_FILES[$input_value]["name"]) && $_FILES[$input_value]["size"]>0) {
									...
									if (!isset($file_info["extension"]) || in_array($file_extension,$arr_ext))
									{
										$bret = false;
										if (trim($default_error_message)=="")
											$this->arrmessages[] = sprintf(E_VAL_NOT_FILE_EXTENSION_CHECK_FAILED_LAN, $command_value, $field_title);
										else
											$this->arrmessages[] = sprintf($default_error_message, $field_title);
									}
								}
				...
				case "file-size":
							if(isset($input_value) && strlen($input_value)>0){
									echo $command_value." ".$_FILES[$input_value]["name"];
								exit;
    ...
    if(!isset($input_value) || strlen($input_value)<=0 || trim($input_value)=="")
		{	
			$bret=false;
			if (trim($default_error_message)=="")
				$this->arrmessages[] = sprintf(E_VAL_REQUIRED_VALUE_LAN ,$variable_name);
			else
	...
	function validateMinLen($input_value,$min_len,$variable_name,&$default_error_message)
	{
		...
		if(isset($input_value) )
		{
			...
			if($input_length < $min_len)
			{
				$bret=false;
				if (trim($default_error_message)=="")
					$this->arrmessages[] = sprintf(E_VAL_MINLEN_CHECK_FAILED_LAN,$min_len,$variable_name);
				else
					$this->arrmessages[] = sprintf($default_error_message,$variable_name);
			}
		}
	...
	function validateLessThan($command_value,$input_value,
                $variable_name,&$default_error_message)
	{
		$bret = true;
		if(false == $this->validateForNumericInput($input_value,
                                    $bret))
		{
			return $bret;
		}
		if($bret)
		{
			...
			if($float_inputval >= $lessthan)
			{
				...
				if (trim($default_error_message)=="")
				{
					$this->arrmessages[] = sprintf(E_VAL_LESSTHAN_CHECK_FAILED_LAN,
											$lessthan,
											$variable_name);
				}
				else
	...
	function validateGreaterThan($command_value,$input_value,$variable_name,&$default_error_message)
	{
		...
		if($bret)
		{
			...
			if($float_inputval <= $greaterthan)
			{
				if (trim($default_error_message)=="")
				{
					$this->arrmessages[] = sprintf(E_VAL_GREATERTHAN_CHECK_FAILED_LAN,
											$greaterthan,
											$variable_name);
				}
				else
		...
		{	
			...
			{	
				if (trim($default_error_message)=="")
				{
					...
					$this->arrmessages[] = sprintf(E_VAL_DATEGREATERTHAN_CHECK_FAILED_LAN,
											$command_valuechk,
											$variable_name);
				}
				else
		...
		{	
			...
			if($greaterdate <= $smalldate)
			{
				if (trim($default_error_message)=="")
				{
					...
					$this->arrmessages[] = sprintf(E_VAL_DATESMALLERTHAN_CHECK_FAILED_LAN,
											$command_valuechk,
											$variable_name);
				}
				else
	...
	function validateCompareGreaterThan($command_value, $input_value, $variable_name, &$default_error_message)
	{
		...
		if ($arr_values[0]>$arr_values[1])
		{
				if (trim($default_error_message)=="")
				{
					$this->arrmessages[] = sprintf(E_VAL_COMPANR_GREATERTHAN_CHECK_FAILED_LAN,
    ...
    function validateSelect($input_value,$command_value,&$default_error_message,$variable_name)
    {
        ...
        {
					if (trim($default_error_message)=="")
						$this->arrmessages[] = sprintf(E_VAL_SHOULD_SEL_CHECK_FAILED_LAN, $command_value,$variable_name);
					else
						$this->arrmessages[] = sprintf($default_error_message,$variable_name);
        }
	    return $bret;
		...
		if(is_array($input_value))
		{
			foreach($input_value as $value)
			{
				if($value == $command_value)
				{
					$bret=false;
				if (trim($default_error_message)=="")
					$this->arrmessages[] = sprintf(E_VAL_DONTSEL_CHECK_FAILED_LAN,$variable_name);
				else
					$this->arrmessages[] = sprintf($default_error_message,$variable_name);
					break;
				}
