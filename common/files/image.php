...
/**
 * IMAGEMODULE (i.e. plans, judges, sponsors)
 * IMAGENAME (i.e. 1.png, 2.jpg, 3.gif)
 * MODULETITLE (i.e. Plan Title, Judge Name)
 * 
 * <img src='<?php echo SERVER_HOST ?>common/files/IMAGEMODULE/image.php/
 * 	IMAGENAME?width=75&amp;height=75&amp;cropratio=1:1&amp;image=/files/IMAGEMODULE/
 *  IMAGENAME' alt='MODULETITLE' />
 *  
 **/
	
define("DOCUMENT_ROOT",$_SERVER['DOCUMENT_ROOT']."/common/");
...
if (!file_exists($docRoot . $image))
{
	...
	echo 'Error: imageg does not exist: ' . $docRoot . $image;
	exit();
}
