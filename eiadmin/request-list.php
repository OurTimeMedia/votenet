<?php	
	...
	$arrw = $objpaging->set_page_details($obj,'request-list.php',$records_per_page,$condition);
	$inttotal_column = 6;
?>
                              ...
                              <td align="left" valign="middle">
								<table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                      ...
                                      <td align="left" valign="top" width="5"></td>
                                      <td align="left" valign="top"><input type="button" name="btnreset" class="button" id="btnreset" value="Reset" onclick="javascript:window.location.href='request-list.php?search=reset';" /></td>
                                    </tr>
                                  </table>
                                </td>
                            </tr>
                              ...
                              <tr>
                                <td align="left" valign="top"><table cellpadding="0" cellspacing="0" border="0" width="100%" class="listmn">
									...
									?>
									  ...
									  <th align="left" valign="top"> Phone
                                        <?php $objpaging->_sortimages('phone', $cmn->getcurrentpagename()); ?>
                                      </th>									  
                                    </tr>
                                    <?php 
									if (count($arrw)>0)
									...
									?>
                                      <td align="left" valign="middle" height="25">
                                      	<a  class="edit" href="request-addedit.php?mode=show&id=<?php echo (int) $rw['id']; ?>">
									  ...
									  <td align="left" valign="middle" height="25">
                                      	<a  class="edit" href="request-addedit.php?mode=show&id=<?php echo (int) $rw['id']; ?>">
											<?php echo $cmn->textLimit(strip_tags($cmn->getval($rw['phone'])),100); ?>
                                        </a>
                                      </td>
                                    ...
                                    <tr>
                                      <?php 
										if ( $user_rights_array['delete'] ) {
										?>
                                      <td align="center" valign="middle" height="25"><input type="button" name="btndelete" class="button" value="Delete" onclick="javascript: set_action('delete','request');"/></td>
                                      <?php 
										}
										?>
                                    <td align="left" valign="middle" height="25" colspan="<?php echo $inttotal_column; ?>">
										...
										?>
                                        <input type="button" name="btnexport" class="button" value="Export" onclick="javascript: set_action('export','request');"/>
                                        <?php
											}
										?>
