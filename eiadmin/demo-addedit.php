<?php
	...
	$record_condition = '';
	if ($strmode=='edit' && !($cmn->is_record_exists('demo', 'id', $id, $record_condition)))
		$msg->send_msg('demo-list.php','',46);
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
          <tr valign="top">
            <td class="main-content"><table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td align="left" valign="top" class="box-heading"><h2>View <?php echo ($obj->request_for == 'demo') ? 'Demo' : 'Video'; ?> request Detail</h2></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td align="left" valign="top">
					<table cellpadding="0" cellspacing="0" border="0" align="left" class="frmmn view-table" width="550">
                      ...
                      <tr>
                        <td align="left" valign="top"width="150"><label>Request for:</label></td>
                        <td align="left" valign="top"><?php echo ucfirst(htmlspecialchars($obj->request_for)); ?></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"><input type="button" name="btnback" class="button" id="btnback" onclick="javascript:window.location.href='demo-list.php'" value="Back" /></td>
                      </tr>
                    </table>
                    </td>
                </tr>
