<?php 
	...
	$arrw=$objpaging->set_page_details($objuser_role,"user-role-list.php",PAGESIZE,$cond);
	$array_lookup_table=array( array("table"=>"user","field"=>"user_role_id"), array("table"=>"user_rights","field"=>"user_role_id"));
	$inttotal_column = 1;
?>
						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
                        	<tr>
                            	<td align="left" valign="middle">
                                	    <table cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                              ...
                                              <td align="left" valign="top" width="5"></td>
                                              <td align="left" valign="top"><input type="button" name="btnreset" class="button" id="btnreset" value="Reset" onclick="javascript:window.location.href='user-role-list.php';" /></td>
                                            </tr>
                                          </table>
                                </td>
                                <?php 
                                ...
                                <td align="right" valign="middle">
                                	<a href="user-role-addedit.php" class="new-record-link">New User Role</a>
                                </td>
                                <?php 
									}
								?>
									...
									?>
													<tr class="<?php echo $rowclass; ?>">
                                                      ...
                                                      <td align="center" valign="middle" height="25">
													  	<input type="checkbox" name="deletedids[]" id="deletedids" value="<?php echo (int) $rw['user_role_id']; ?>" <?php if ( ! $cmn->validatedeletedids((int)$rw["user_role_id"],$array_lookup_table) ) echo 'disabled="disabled"'; ?> />
													  </td>
                                                      <?php 
														}
													  ?>
													  <td align="left" valign="middle" height="25">
													  	<a  class="edit" href="user-role-addedit.php?mode=edit&user_role_id=<?php echo (int) $rw['user_role_id']; ?>">
                                                      ...
                                                      <?php 
													  	if ( $user_rights_array['edit'] ) {
													  ?>
													  <td align="center" valign="middle" height="25"><input type="checkbox" name="activeids[]" id="activeids" value="<?php echo (int) $rw['user_role_id']; ?>" <?php if ( $rw['user_role_active'] == 'y' ) echo 'checked=checked'; ?> /></td>
                                                      <?php 
														}
													  ?>
													</tr>
									...
									?>
											<tr>
											  <?php 
											  	if ( $user_rights_array['delete'] ) {
											  ?>
                                              <td align="center" valign="middle" height="25"><input type="button" name="btndelete" class="button" id="btndelete" value="Delete" onclick="javascript: set_action('delete','user role');" /></td>
                                              <?php 
												}
											  ?>
											  <td align="left" valign="middle" height="25">
												...
												?>
	                                                <input type="button" name="btnexport" class="button" id="btnexport" value="Export to CSV" onclick="javascript: set_action('export','user role');" />
                                               	<?php 
													}
												?>
											  ...
											  <?php 
											  	if ( $user_rights_array['edit'] ) {
											  ?>
                                              <td align="center" valign="middle" height="25"><input type="button" name="btnactive" class="button" id="btnactive" value="Save" onclick="javascript: set_action('active','user role');" /></td>
                                              <?php 
												}
											  ?>
											</tr>
